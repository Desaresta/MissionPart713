...
public class FatherRoom extends javax.swing.JFrame {
    public FatherRoom() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Code_ButlerRoom = new javax.swing.JButton();
        ...
        Text.setText("ห้องพ่อ");
        jPanel.add(Text);
        Text.setBounds(0, 0, 180, 60);

        BG.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        BG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Picture/FatherRoom.png"))); // NOI18N
        BG.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jPanel.add(BG);
        BG.setBounds(0, 0, 1280, 720);

        Code_ButlerRoom.setText("Code");
        Code_ButlerRoom.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        Code_ButlerRoom.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Code_ButlerRoomActionPerformed(evt);
            }
        });
        jPanel.add(Code_ButlerRoom);
        Code_ButlerRoom.setBounds(1162, 484, 40, 40);
    ...
    private void Code_ButlerRoomActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Code_ButlerRoomActionPerformed
        File backk = new File("page-flip.wav");
        Playsound(backk);
        String names[] = { "579", "589", "586", "592", "801", "277" };
        Random Dice = new Random(); 
        int n = Dice.nextInt(6); 
        
        JOptionPane.showInternalMessageDialog(null, "Password  : "  + names[n]);
    }//GEN-LAST:event_Code_ButlerRoomActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FatherRoom().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton Code_ButlerRoom;
