...
public class Note_mother extends javax.swing.JFrame {
    public Note_mother() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Note.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Picture/Note_mother.png"))); // NOI18N
        jPanel.add(Note);
    ...
    private void BackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BackActionPerformed
        ...
        Playsound(backk);
        MotherRoom back = new MotherRoom();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Note_mother().setVisible(true);
            }
        });
    }
