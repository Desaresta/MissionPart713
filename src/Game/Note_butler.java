...
public class Note_butler extends javax.swing.JFrame {
    public Note_butler() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Note.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Picture/Note_butler.png"))); // NOI18N
        jPanel.add(Note);
    ...
    private void BackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BackActionPerformed
        ...
        Playsound(backk);
        ButlerRoom back = new ButlerRoom();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Note_butler().setVisible(true);
            }
        });
    }
