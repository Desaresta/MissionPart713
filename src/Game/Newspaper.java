...
public class Newspaper extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Newspaper.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        Newspaper.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Picture/Newspaper.png"))); // NOI18N
        jPanel.add(Newspaper);
        Newspaper.setBounds(0, 0, 1280, 720);
    ...
    private void BackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BackActionPerformed
        ...
        Playsound(backk);
        LibraryRoom back = new LibraryRoom();
