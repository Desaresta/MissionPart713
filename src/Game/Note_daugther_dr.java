...
public class Note_daugther_dr extends javax.swing.JFrame {
    public Note_daugther_dr() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Note.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Picture/Note_daugther_dr.png"))); // NOI18N
        jPanel.add(Note);
        Note.setBounds(0, 0, 1280, 720);
    ...
    private void BackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BackActionPerformed
        ...
        Playsound(backk);
        DaughterRoom back = new DaughterRoom();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Note_daugther_dr().setVisible(true);
            }
        });
    }
