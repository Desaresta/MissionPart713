...
public class Note_daugther extends javax.swing.JFrame {
    public Note_daugther() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Note.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Picture/Note_daugther.png"))); // NOI18N
        jPanel.add(Note);
    ...
    private void BackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BackActionPerformed
        ...
        Playsound(backk);
        LivingRoom back = new LivingRoom();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Note_daugther().setVisible(true);
            }
        });
    }
