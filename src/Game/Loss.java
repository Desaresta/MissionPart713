...
public class Loss extends javax.swing.JFrame implements MyUtil{
    public Loss() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        BG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Picture/Loss.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try{ 
                FileInputStream fileInputStream = new FileInputStream("Mystery.mp3");
